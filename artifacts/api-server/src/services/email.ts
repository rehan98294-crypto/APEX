...
// Inline SVG logo — zero external dependencies, no base64 bloat
const APEX_LOGO_SVG = `
<svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    <linearGradient id="g1" x1="0" y1="0" x2="44" y2="44" gradientUnits="userSpaceOnUse">
      <stop offset="0%" stop-color="#5CBFFE"/>
      <stop offset="50%" stop-color="#2BD9A8"/>
      <stop offset="100%" stop-color="#FFB08A"/>
    </linearGradient>
  </defs>
  <text x="22" y="30" font-family="Arial,sans-serif" font-size="22" font-weight="900"
...
<svg width="16" height="16" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"
  ...
  <path d="M50 4 L56 15 L68 10 L71 23 L84 23 L82 36 L94 42 L88 54 L96 64
           L85 71 L88 84 L75 85 L70 97 L58 91 L50 100 L42 91 L30 97 L25 85
           L12 84 L15 71 L4 64 L12 54 L6 42 L18 36 L16 23 L29 23 L32 10 L44 15 Z"
    fill="#1D9BF0"/>
  <path d="M33 50 L44 62 L67 37" stroke="white" stroke-width="9"
...
export async function sendEmail(
  ...
  console.log(`[Email] Sending "${subject}" → ${to} via ${host}:${port}`);
...
export function buildOtpEmail(code: string, action: "verify" | "reset"): string {
  ...
  const title   = isReset ? "Reset Your Password" : "Email Verification";
  const body    = isReset
  ...
  <table width="100%" style="max-width:480px;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #E5E8EE;">
    ...
    <tr>
      <td style="padding:28px 32px 20px;">
        <table cellpadding="0" cellspacing="0">
          <tr>
            <td style="padding-right:12px;vertical-align:middle;">${APEX_LOGO_SVG}</td>
    ...
    <tr>
      <td style="padding:28px 32px;">
        <h2 style="margin:0 0 10px;color:#1A1A2E;font-size:24px;font-weight:800;letter-spacing:-0.4px;">${title}</h2>
        <p style="color:#6B7280;margin:0 0 28px;font-size:14px;line-height:1.7;">${body}</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td style="vertical-align:middle;">
              ...
              ${BLUE_TICK_SVG.replace('width="16" height="16"', 'width="12" height="12"')}
            </td>
